  ...
  return (
    <View testID="WalletScreen" style={FULL}>
      <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
        <Text style={TITLE} preset="header" tx="walletScreen.OPTNWallet" />
        <Image source={logo} style={BOWSER} />
        <Text style={TITLE_WRAPPER}>
          <Text style={TITLE} text="A " />
          <Text style={ALMOST} text="Bitcoin Bay " />
          <Text style={TITLE} text="project!" />
        </Text>
        <Button
          testID="next-screen-button"
          style={CONTINUE}
          textStyle={CONTINUE_TEXT}
          tx="walletScreen.create"
          onPress={nextScreen}
        />
        <Button
          testID="next-screen-button"
